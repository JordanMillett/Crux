...
:: debug variant
dotnet publish Game\Game.csproj -c Debug -r win-x86 --self-contained true -p:PublishSingleFile=false -p:PublishTrimmed=false -o Game\bin\Builds\win-x86-standalone-multi-file-DEBUG\
