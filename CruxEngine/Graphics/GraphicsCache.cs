...
public static class GraphicsCache
{
    ...
    public static Dictionary<(string cacheKey, bool instanced), (int id, int users)> Vertex = new();
    public static Dictionary<(string cacheKey, bool instanced), (int id, int users)> Fragment = new();
